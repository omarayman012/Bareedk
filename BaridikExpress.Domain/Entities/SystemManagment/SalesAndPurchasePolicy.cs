...
public class SalesAndPurchasePolicy : BaseEntity
{
    public Guid Id { get; private set; }
    public string? DescriptionAr { get; private set; }
    public string? DescriptionEn { get; private set; }

    private SalesAndPurchasePolicy() { }

    public static SalesAndPurchasePolicy Create(
        string? descriptionAr = null,
        string? descriptionEn = null)
    {
        return new SalesAndPurchasePolicy
        {
            Id = Guid.NewGuid(),
