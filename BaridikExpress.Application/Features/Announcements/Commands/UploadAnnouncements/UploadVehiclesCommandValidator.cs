...
{
    public class UploadAnnouncementsCommandValidator:AbstractValidator<UploadAnnouncementsCommand>
    {

        public UploadAnnouncementsCommandValidator(IStringLocalizer localizer)
        {
            RuleFor(x => x.File)
                .NotNull()
