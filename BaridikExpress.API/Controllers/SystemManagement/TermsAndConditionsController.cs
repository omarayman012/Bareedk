...
public class TermsAndConditionsController(IMediator mediator) : ControllerBase
{
    [HttpGet]
    [AllowAnonymous]
    ...
    {
        var result = await mediator.Send(new GetSystemManagementQuery<TermsAndConditions>(), cancellationToken);
        return StatusCode(result.StatusCode, result);
    }

    [HttpPut]
    public async Task<IActionResult> Update(
        [FromBody] UpdateSystemManagementCommand<TermsAndConditions> command,
