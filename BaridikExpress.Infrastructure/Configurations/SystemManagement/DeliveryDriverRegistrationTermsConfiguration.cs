...
public class DeliveryDriverRegistrationTermsConfiguration : IEntityTypeConfiguration<DeliveryDriverRegistrationTerms>
{
    public void Configure(EntityTypeBuilder<DeliveryDriverRegistrationTerms> builder)
    {
        builder.ToTable("DeliveryDriverRegistrationTerms");
